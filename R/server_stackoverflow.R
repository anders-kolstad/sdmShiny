# This is a working example that accompanies the question posted on stackoverflow:
# https://stackoverflow.com/questions/61673959/sdm-package-fails-in-shiny-io
